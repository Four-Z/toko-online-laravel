            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="/products/hoodie">Hoodie</a>
                                <a class="dropdown-item" href="/products/crewneck">Crewneck</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="{{route('products')}}">Semua Kategori</a>
                            </div>
                          </li>
                        <li class="nav-item">
                            <a class="nav-link active" href="{{ route('history') }}">History Pembelian</a>
                        </li>
                    </ul>
                    ...
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item">
                            <a class="nav-link active" href="{{ route('keranjang') }}">
